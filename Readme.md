...
# 4. File formats.
## 4.1 *.kpp file
Keywords file of PhiPsi, composed of keywords that begin with character "*", see Section 5 for details on [PhiPsi Keywords manual](http://www.phipsi.top/phipsi_keywords_manual.html). The lines beginning with character "%" are comment lines. For example:
...
These three files contain information about external forces, define nodes with force applied in $x$, $y$, and $z$ directions, respectively. For example, the following lines presented in *.focx file indicates that nodes 487 to 489 are under the action of force at 4.5 KN in $x$ direction:
~~~bash
	487   0.45000000E+04
	488   0.45000000E+04
	489   0.45000000E+04
