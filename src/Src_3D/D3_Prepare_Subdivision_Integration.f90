!-----------------------------------------------------------
! Brief: Prepare block-subdivision data for XFEM sub-element integration.
!
! Parameters:
!   Input: c_isub - current substep index
!
! Notes:   Classifies each (element, crack) pair by the number of
!          crack-edge intersections and allocates arrays used by
!          the per-case sub-element integrators. Marked abandoned.
!-----------------------------------------------------------
