!-----------------------------------------------------------
! Brief: Build local coordinate frames at crack outline vertices.
!
! Parameters:
!   Input:  iter - iteration counter for log/debug purposes
!
! Notes:   Stores x/y/z vectors for each crack outline vertex in
!          Crack3D_Meshed_Vertex_x/y/z_Vector using the angle bisector
!          of adjacent outline edges and the crack center as the reference.
!-----------------------------------------------------------
...
do i_C =1,num_Crack
    ...
    do i_V =1,num_Cr_Edges
        ...
        call Tool_ThetaX_ThetaY_ThetaZ_3D_rotation(i_V, Vector_x(1:3),Vector_y(1:3),Vector_z(1:3), &
