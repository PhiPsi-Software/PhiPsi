!-----------------------------------------------------------
! Brief: Snap a crack's normal to the nearest regular direction.
!
! Parameters:
!   Input: i_C         - crack index
!          c_Crack_Type - 1: rect/polygon, 2: circle, 3: ellipse
!
! Notes:   Picks the candidate normal (from a set of 6, 18, or
!          finer resolution) that has the smallest angle with the
!          current normal, then rotates the crack into alignment.
!-----------------------------------------------------------
