!-----------------------------------------------------------
! Brief: Move crack outline vertices off solid element faces.
!
! Parameters:
!   Input:  iter - adjustment iteration index
!
! Notes:   For each crack boundary vertex, finds the host element via
!          D3_Get_Point_Domain_Number and nudges the vertex off any
!          element face it lies on. OpenMP-parallelised.
!-----------------------------------------------------------
