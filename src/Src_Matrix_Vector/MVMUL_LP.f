...
C     Matrix A is multiplied by vector B.
c     A(m,n),V(n),Output(m,n)
C     Using the Lapack library.
C     Written on 2021-02-14.
c     To use this function: use Function_MATMUL_LP
