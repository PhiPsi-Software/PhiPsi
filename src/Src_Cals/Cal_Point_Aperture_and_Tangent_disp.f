      ...
      subroutine Cal_Point_Aperture_and_Tangent_disp(c_Crack,Point,
     &                       c_DISP,Cr_Omega,Aperture,Tangent_disp)
     ...
     &                 Up_Disp_Pro(2),Low_Disp_Pro(2),Disp_Normal(2)
      ...
      call Cal_Any_Point_Disp_KesiYita(c_Elem,c_Kesi,c_Yita,0,c_DISP,
     &                                 Up_Disp)
