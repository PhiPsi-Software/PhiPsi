!-----------------------------------------------------------
! Brief: Compute asymptotic auxiliary stress/strain/grad-u fields.
!
! Parameters:
!   Input:  Mode     - I (1) or II (2) loading mode
!           r,theta  - polar coordinates relative to crack tip
!           G        - shear modulus
!           nu       - Poisson's ratio
!           kappa    - Kolosov constant (3-4nu for plane strain)
!   Output: Aux_Sig  - asymptotic stress tensor (3x3)
!           Aux_Eps  - asymptotic strain tensor (3x3)
!           Aux_Grad_u - displacement gradient tensor (3x3)
!
! Notes:   Part 1 of the Interaction Integral Method auxiliary
!          fields at unit K_I=1 or K_II=1. Plane-strain assumption.
!-----------------------------------------------------------
