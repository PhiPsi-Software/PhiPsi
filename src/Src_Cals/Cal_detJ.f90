!-----------------------------------------------------------
! Brief: 2D 4-node quad Jacobian determinant.
!
! Parameters:
!   Input:  kesi, yita        - natural-coord point
!           X_NODES(4), Y_NODES(4) - nodal coordinates
!   Output: detJ              - Jacobian determinant at (kesi,yita)
!-----------------------------------------------------------
...
temp(1,:) =[(yita-ONE)/FOU,(-yita+ONE)/FOU, (yita+ONE)/FOU,(-yita-ONE)/FOU]
temp(2,:) =[(kesi-ONE)/FOU,(-kesi-ONE)/FOU, (kesi+ONE)/FOU,(-kesi+ONE)/FOU]
