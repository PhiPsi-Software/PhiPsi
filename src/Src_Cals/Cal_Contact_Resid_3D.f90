!-----------------------------------------------------------
! Brief: Compute the full contact residual vector for the 3D penalty method.
!
! Parameters:
...
!           PC_Gauss_x/y/z    - contact forces at Gauss points
!   Output: R_PSI             - contact residual vector
!
! Notes:   3D analog of Cal_Contact_Resid. Integrates contact contributions
!          at fluid-element Gauss points and assembles into the global
!          residual with OpenMP parallelism.
!-----------------------------------------------------------
...
yita_Enr(Num_Gau_Points_3D), zeta_Enr(Num_Gau_Points_3D), weight_Enr(Num_Gau_Points_3D)
real(kind=FT) kesi_No_Enr(Num_Gauss_P_FEM_3D), &
yita_No_Enr(Num_Gauss_P_FEM_3D), zeta_No_Enr(Num_Gauss_P_FEM_3D), weight_No_Enr(Num_Gauss_P_FEM_3D)
