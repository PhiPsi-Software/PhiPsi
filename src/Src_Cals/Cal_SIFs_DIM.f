...
c     Calculating stress intensity factors using the displacement interpolation method.
c     After the calculation is completed, pass it to the public variables KI and KII.
