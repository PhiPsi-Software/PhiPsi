!-----------------------------------------------------------
! Brief: Compute the line integral of the q weight along a crack front.
!
! Parameters:
!   Input:  i_Crack          - crack index
!           i_Vertex         - front vertex index
!           L_front          - half-length of the front core region
!   Output: q_line_integral  - integral of q(s) over the support
!
! Notes:   Uses 100 trapezoidal segments spanning [-2*L_front, 2*L_front]
!          to integrate the piecewise-linear front factor of q.
!-----------------------------------------------------------
