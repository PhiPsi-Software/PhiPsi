!-----------------------------------------------------------
! Brief: Classify contact state at each 3D contact fluid-element GP.
!
! Parameters:
...
!
! Notes:   3D version; iterates fluid crack elements with OpenMP
!          parallelisation and uses the configured aperture tolerance.
!-----------------------------------------------------------
