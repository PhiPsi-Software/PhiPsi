...
!     ------------------------------------------------- !
     ...
     &                CT_State_Gauss) 
c     Obtain the contact state of each Gauss point in the contact element and store it in CT_State_Gauss for the penalty function contact detection algorithm.
