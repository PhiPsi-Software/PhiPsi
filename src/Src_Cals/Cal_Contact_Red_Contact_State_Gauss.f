...
!     ------------------------------------------------- !
     ...
     &                CT_State_Gauss) 
c     Obtain the contact status of each Gauss point in the contact element and store it in CT_State_Gauss for the penalty function contact detection algorithm.
c     Also save the element contact status (c_Elem_Conta_Sta) for post-processing
c     --------------------
c     Description: Suitable for reduced-contact iterative algorithms

c     integer CT_State_Gauss(num_Crack, Max_Num_Cr_CalP-1, 2)
                                                                   ! = 0, separated; =1, bonding; =2, slip
