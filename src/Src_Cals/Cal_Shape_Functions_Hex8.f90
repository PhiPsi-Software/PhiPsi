!-----------------------------------------------------------
! Brief: Trilinear shape functions and derivatives for Hex8.
!
! Parameters:
!   Input:  xi, eta, zeta  - parent coordinates in [-1,1]
!   Output: N              - 8 shape function values
!           dN_dxi         - 8 derivatives wrt xi
!           dN_deta        - 8 derivatives wrt eta
!           dN_dzeta       - 8 derivatives wrt zeta
!
! Notes:   Returns the standard trilinear Hex8 shape function
!          set; useful for callers needing a compact form
!          separate from the full N/dN/J/detJ routine.
!-----------------------------------------------------------
