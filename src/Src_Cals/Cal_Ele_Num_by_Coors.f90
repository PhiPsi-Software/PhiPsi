!-----------------------------------------------------------
! Brief: Locate the 2D element that contains a given (x,y) point.
!
! Parameters:
...
!
! Notes:   First narrows candidates via axis-aligned bounding-box test, then
!          confirms with point-in-polygon / on-polygon checks.
!-----------------------------------------------------------

subroutine Cal_Ele_Num_by_Coors(x,y,OUT_Elem)
!     Calculate element number based on coordinates
