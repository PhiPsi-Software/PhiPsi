...
c     This subroutine calculates the in-situ stress levels in the x, y, and z directions based on the loads from the model established in ANSYS.
c     Supports sparse matrix storage for the stiffness matrix K_2018-08-02.
c     2022-04-20. NEWFTU2022042001.
