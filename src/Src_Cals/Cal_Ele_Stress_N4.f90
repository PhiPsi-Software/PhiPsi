!-----------------------------------------------------------
! Brief: Compute nodal stress of a 4-node 2D quad element at a given parametric point.
!
! Parameters:
...
!           U        - element nodal displacement vector (8)
!   Output: c_Stress - stress vector (3 components)
!
! Notes:   Computed as D*B*U using the standard isoparametric B matrix.
!-----------------------------------------------------------

subroutine Cal_Ele_Stress_N4(i_E,i_N,X_NODES,Y_NODES, c_D,kesi,yita,U, c_Stress)
