!-----------------------------------------------------------
! Brief: Compute 3D trilinear shape functions for a hex element.
!
! Parameters:
!   Input:  kesi, yita, zeta - parent coords in [-1,1]
!   Output: N               - 3x24 shape function matrix
!
! Notes:   Standard 8-node hex (trilinear) isoparametric
!          shape functions arranged in (u,v,w) dof layout.
!-----------------------------------------------------------
