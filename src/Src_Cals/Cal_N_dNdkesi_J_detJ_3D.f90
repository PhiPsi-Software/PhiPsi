!-----------------------------------------------------------
! Brief: Compute N, dN/dxi, Jacobian and detJ for 3D hex.
!
! Parameters:
...
!           dNdkesi          - 8x3 derivatives wrt parent coords
!
! Notes:   Standard 8-node hex isoparametric mapping used
!          throughout the 3D FEM/XFEM integration routines.
!-----------------------------------------------------------
