...
C     Calculate the element number based on coordinates, in 3D.
c     Cal_Ele_Num_by_Coors_3D cannot find the element number; this subroutine adjusts the position and continues searching.
c     Return to the new location.
c     2021-09-03.
