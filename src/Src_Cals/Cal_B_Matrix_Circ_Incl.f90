!-----------------------------------------------------------
! Brief: Assemble the strain-displacement B matrix for circular inclusions.
!
! Parameters:
...
!
! Notes:   Combines standard FEM rows with XFEM enrichment rows
!          for radial-enrichment inclusions, tracking assembly state.
!-----------------------------------------------------------

subroutine Cal_B_Matrix_Circ_Incl(kesi,yita, i_Incl,i_E,i_G, c_NN,c_X_NODES,c_Y_NODES, tem_B,num_tem_B)

!     Calculate the B matrix (for circular inclusions).
