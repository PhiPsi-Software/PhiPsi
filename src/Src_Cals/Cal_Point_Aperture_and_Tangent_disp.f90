!-----------------------------------------------------------
! Brief: Aperture and tangential slip at a 2D crack point.
!
! Parameters:
...
!           Tangent_disp - tangential slip at the point
!
! Notes:   Uses the same up/down offset scheme as the plain
!          aperture routine, then additionally projects the
!          relative displacement onto the crack tangent.
!-----------------------------------------------------------

subroutine Cal_Point_Aperture_and_Tangent_disp(c_Crack,Point, c_DISP,Cr_Omega,Aperture,Tangent_disp)
...
call Cal_Any_Point_Disp_KesiYita(c_Elem,c_Kesi,c_Yita,0,c_DISP, Up_Disp)

call Cal_Ele_Num_by_Coors(Low_Point(1),Low_Point(2),c_Elem)
call Cal_KesiYita_by_Coor(Low_Point,c_Elem,c_Kesi,c_Yita)
call Cal_Any_Point_Disp_KesiYita(c_Elem,c_Kesi,c_Yita,0,c_DISP, Low_Disp)
...
return 
end subroutine Cal_Point_Aperture_and_Tangent_disp               
