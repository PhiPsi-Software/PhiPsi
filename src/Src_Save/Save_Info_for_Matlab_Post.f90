!-----------------------------------------------------------
! Brief: Saves header metadata describing the run for the MATLAB post-processor.
!
! Parameters:
!
! Notes:   Writes analysis type, crack-tip type, data format, Heaviside and hole
!          flags, and average element length to a single <Full_Pathname>.post file.
!-----------------------------------------------------------
...
write(301, '(6X,I3,10X,I3,13X,I3,13X,I3,13X,I3,5X,F12.5)') Key_Analysis_Type,Key_TipEnrich, &
