!-----------------------------------------------------------
! Brief: Saves the maximum pressure of crack 1 (MPa) per fracture step.
!
! Parameters:
!   Input: ifra_Max_Press - array of max pressures per step
!   Input: Num_Frac       - number of fracture steps
!
! Notes:   Output file is <Full_Pathname>.ipre; only positive entries written.
!-----------------------------------------------------------
...
write(201,*) '    Max pressure (MPa )of crack 1' //' of each time step'
do i=1,Num_Frac
