!-----------------------------------------------------------
! Brief: Assemble the full 3D XFEM stiffness matrix in
...
!
! Notes:   Supports multiple cracks and contact; uses
!          sub-cube or multi-crack integration schemes;
!          reports progress via a console progress bar.
!-----------------------------------------------------------
