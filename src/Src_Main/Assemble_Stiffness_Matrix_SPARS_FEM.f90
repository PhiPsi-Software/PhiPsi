!-----------------------------------------------------------
! Brief: Assemble the 2D FEM stiffness matrix in CSR
!        (compressed sparse row) sparse storage.
!
! Parameters:
...
!
! Notes:   Uses a two-pass algorithm: first scans elements
!          to build a sparse pattern, then accumulates.
!-----------------------------------------------------------
