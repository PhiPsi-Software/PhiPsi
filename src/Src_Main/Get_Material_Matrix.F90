!-----------------------------------------------------------
! Brief: Build the 2D material constitutive matrices for all materials.
!
! Parameters:
!   (none)
!
! Notes:   Allocates and fills the global D, D4, S, St, Sc, T_Alpha,
!          KIc, E, v, thick, density, Lame_lambda, Lame_mu, MC_dt,
!          MC_phi, MC_psi, and MC_c arrays, supporting isotropic and
!          Weibull-distributed modulus and plane-stress/strain branches.
!-----------------------------------------------------------
