!-----------------------------------------------------------
! Brief: Smooth closed 3D crack-front points via Taubin filter
!
! Parameters:
!   Input:  i_C               - crack index
!   Input:  num_Point         - number of front vertices
!   Input:  In_Points         - input front vertex coordinates
!   Input:  Points_Flag_Inside - logical mask for points inside the model
!   Output: Out_Points        - smoothed front vertex coordinates
!
! Notes:   Iterated Taubin smoothing (lambda=0.330, mu=-0.331) skipping outside points.
!-----------------------------------------------------------
