...
c     Randomly generate natural cracks, only applicable to rectangular models
c     Algorithm: Generate one by one, and the midpoint of the subsequently generated crack should not fall within the radius of the midpoint of any other crack.
