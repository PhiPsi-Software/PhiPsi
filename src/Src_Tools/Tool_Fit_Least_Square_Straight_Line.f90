!-----------------------------------------------------------
! Brief: Linear least-squares regression y = k*x + b
!
! Parameters:
!   Input:  x(n),y(n) - input data samples
!   Input:  n         - number of samples
!   Output: k         - fitted slope
!   Output: b         - fitted intercept
!
! Notes:   Closed-form two-moment solution.
!-----------------------------------------------------------
