!-----------------------------------------------------------
! Brief: Load 3D natural fracture data from a FracMan *.fab file.
!
! Parameters:
!   (none)
!
! Notes:   Parses the fab file line-by-line, strips whitespace,
!   and stores vertex coordinates and per-crack metadata in the
!   global crack arrays; aborts with a warning if the file is
!   missing.
!-----------------------------------------------------------

SUBROUTINE Tool_Read_fab_Natural_Fractures_3D
! Subroutine function: Read natural fracture data from FracMan *.fab files.
!2022-07-24.
