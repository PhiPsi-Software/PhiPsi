!-----------------------------------------------------------
! Brief: Removes interior collinear points from a 3D point sequence.
!
! Parameters:
!   Input:  input_points, input_point_num - original point cloud
!   Output: output_points, output_point_num - reduced list preserving endpoints
!
! Notes:   First and last points are always retained; interior points collinear
!          with their neighbours are dropped via Tool_Yes_Three_Points_Collinear.
!-----------------------------------------------------------
