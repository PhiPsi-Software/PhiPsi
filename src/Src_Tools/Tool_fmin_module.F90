!-----------------------------------------------------------
! Brief: Provides Brent's 1D derivative-free minimizer fmin over a bounded interval.
!
! Parameters:
!   (none - module definition)
!
! Notes:   Declares an abstract function interface and exposes the public
!          function fmin, which combines golden-section search with
