!-----------------------------------------------------------
! Brief: Compute the intersection of a 3D segment with a 3D triangle
!
! Parameters:
!   Input:  A, B            - Endpoints of the 3D segment
!   Input:  Point1..Point3  - Triangle vertices
!   Output: Yes_Inter       - True if the segment meets the triangle
!   Output: InterSection_P  - Coordinates of the intersection
!
! Notes:   Adapted from the Matlab geom3d intersectLineTriangle3d
!          routine; uses the line-plane intersection plus barycentric test.
!-----------------------------------------------------------

subroutine Tool_Intersection_of_AB_and_Triangle_3D(A,B, Point1,Point2,Point3, Yes_Inter,InterSection_P)
!     Calculate the intersection point of line segment AB and the spatial triangle (Point1, Point2, Point3)
!     Tri_Circum represents the perimeter of a spatial triangle
!     http://matgeom.sourceforge.net/doc/api/matGeom/geom3d/intersectLineTriangle3d.html
