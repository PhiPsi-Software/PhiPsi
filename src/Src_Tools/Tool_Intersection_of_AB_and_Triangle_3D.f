...
C     Calculate the intersection point of line segment AB and the spatial triangle (Point1, Point2, Point3)
c     Tri_Circum represents the perimeter of a spatial triangle
c     http://matgeom.sourceforge.net/doc/api/matGeom/geom3d/intersectLineTriangle3d.html
