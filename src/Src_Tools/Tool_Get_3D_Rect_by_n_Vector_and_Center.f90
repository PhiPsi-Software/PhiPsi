!-----------------------------------------------------------
! Brief: Build a 3D square (rotated rectangle) from a normal, center, and side length.
!
! Parameters:
!   Input:  n_Vector(3) - square normal vector
!   Input:  c_Crack_Center(3) - center of the square
!   Input:  Crack_L - side length of the square
!   Output: Out_Coors(4,3) - four corner coordinates
!
! Notes:   Constructs an in-plane orthonormal basis from the
!   normal, then samples a 3D circle at four equally spaced
!   angles to obtain the corners.
!-----------------------------------------------------------

subroutine Tool_Get_3D_Rect_by_n_Vector_and_Center(n_Vector, c_Crack_Center,Crack_L, Out_Coors)
