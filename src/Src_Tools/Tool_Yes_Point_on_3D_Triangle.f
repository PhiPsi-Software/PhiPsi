...
C     Determine whether a point in space lies on the plane of a spatial triangle.
c     Algorithm: If point p is inside the triangle, then the original triangle ABC is divided into three triangles: ABP, ACP, and BCP.
c     The sum of the areas of the three triangles equals the area of triangle ABC.
c     2020-01-17
