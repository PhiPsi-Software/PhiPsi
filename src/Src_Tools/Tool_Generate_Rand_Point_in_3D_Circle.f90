!-----------------------------------------------------------
! Brief: Generate a uniform random point inside a 3D circle.
!
! Parameters:
!   Input:  Center(3) - center of the circle
!   Input:  n_Vector(3) - normal of the circle's plane
!   Input:  Radius - radius of the circle
!   Output: Rand_Point(3) - sampled point in the disk
!
! Notes:   Builds two orthogonal in-plane basis vectors and
!   combines random angle and radius to place the point.
!-----------------------------------------------------------

subroutine Tool_Generate_Rand_Point_in_3D_Circle( Center,n_Vector,Radius, Rand_Point)
!     Randomly generate points inside a 3D circle.
!     2022-06-16.
