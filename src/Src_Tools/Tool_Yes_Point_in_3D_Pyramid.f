...
!     ------------------------------------------------- !
      ...
      subroutine Tool_Yes_Point_in_3D_Pyramid(Point,
     &                            A,B,C,D,E,
     &                            Yes_in,Yes_on)
C     Determine whether a point in space is inside a spatial quadrilateral pyramid (split it into two spatial tetrahedrons to determine, A-BCE, A-CDE)
     ...
     &                 A(3),B(3),C(3),D(3),E(3)
      ...
      call Tool_Yes_Point_in_3D_Tetrahedron(Point,
     &                            A,B,C,E,
