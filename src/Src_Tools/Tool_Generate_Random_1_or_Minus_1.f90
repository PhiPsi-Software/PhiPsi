!-----------------------------------------------------------
! Brief: Generate a pseudorandom sign value of +1 or -1.
!
! Parameters:
!   Output: out_number - a real value set to +1 or -1
!
! Notes:   Uses the same Lehmer-style generator as the random
!   number routine, then maps the [0,1) output to a sign.
!-----------------------------------------------------------
