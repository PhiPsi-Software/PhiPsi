...
c     Key_Smooth_Front=3, cubic spline fitting.
C     Call \Python_Tools\Smooth_3D_Points_CSAPS.py.
c     Ref: https://pypi.org/project/csaps/.
c
c     ---------or---------
c
c     Key_Smooth_Front=4, B-spline fitting.
C     Call \Python_Tools\Smooth_3D_Points_Scipy.py.
c     Ref: https://stackoverflow.com/questions/18962175/spline-interpolation-coefficients-of-a-line-curve-in-3d-space.
c     Ref: https://docs.scipy.org/doc/scipy/reference/generated/scipy.interpolate.splprep.html
c
c              
c     Firstly written on 2021-11-01.
