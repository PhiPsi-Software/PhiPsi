...
c     Load vector (excluding active and inactive elements, and without considering the external load correction for initial stress from Zienkiewicz_7ed_P216; used for initial stress field calculation).
c     Note: The initial stress field calculation does not take pore water pressure into account, 2020-03-15.
